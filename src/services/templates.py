...
from src.schemas.templates import AddTemplateDTO, RequestAddTemplateDTO, TemplateDTO, TemplateUpdateDTO
...
class TemplateService(BaseService):
    ...
    async def add_template(self, data: RequestAddTemplateDTO, user_meta: dict) -> TemplateDTO:
    ...
    async def update_template(self, data: TemplateUpdateDTO, template_id: int, user_meta: dict) -> None:
